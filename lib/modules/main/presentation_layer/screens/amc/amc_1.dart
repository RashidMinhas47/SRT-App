...
import 'package:bayanat/modules/main/presentation_layer/screens/amc/amc_2.dart';
...
class AmcScreen1 extends StatelessWidget {
  final JobCard jobCard;
  const AmcScreen1({super.key, required this.jobCard});
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Stack(
              children: [
                screenCoverBuilder(40,title: "JOB CARD NAME",width: 0.1/2),
                ...
                child: Table(
                  ...
                  children: [
                    ...
                    TableRow(children: [
                      ...
                      jobCardDataItemBuilder(
                          title: 'Building Number', value: jobCard.buildingNumber)
                    ]),
                    TableRow(children: [
                      jobCardDataItemBuilder(
                          title: 'House/Flat Number', value: jobCard.flatNumber),
                      jobCardDataItemBuilder(
